...
from Audio_gen.generate_audio import generate_audio_files
def display_flashcards(flashcards_df, num_columns=1, cards_per_page=50):
    ...
    generate_audio_files(page_flashcards_df)
    rows = [
