...
class AppSidebar:
    ...
    def download_results(self):
        with expander("Download", expanded=False, icon="📥"):
            ...
            download_button("💹 xlsx", buffer.getvalue(), f"Results_{session_state.uploaded_file_data.name[:-5]}.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", use_container_width=True)